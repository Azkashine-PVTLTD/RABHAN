...
exports.logAccess = exports.requireContractorOwnership = exports.userBasedRateLimit = exports.requirePermission = exports.requireAdmin = exports.optionalAuth = exports.authenticateToken = void 0;
...
const authenticateToken = (req, res, next) => {
    try {
        ...
        // Verify JWT token
        jsonwebtoken_1.default.verify(token, environment_config_1.config.JWT_SECRET, (err, decoded) => {
            if (err) {
...
const requirePermission = (permission) => {
    return (req, res, next) => {
        ...
        if (!req.user.permissions.includes(permission) && !req.user.isAdmin) {
            logger_1.logger.warn('Unauthorized permission access attempt', {
                user_id: req.user.id,
 ...
 */
const requireContractorOwnership = (req, res, next) => {
    if (!req.user) {
        res.status(401).json({
            success: false,
            error: {
...
exports.requireContractorOwnership = requireContractorOwnership;
/**
...
const logAccess = (req, res, next) => {
    ...
    // Log the request
    logger_1.logger.info('API access', {
        method: req.method,
        url: req.originalUrl,
        user_id: req.user?.id,
        ip_address: req.ip,
