...
export class AuthController {
  ...
  contractorRegister = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const companyInfo = {
        companyName: (data as any).company_name || (data as any).companyName,
        crNumber: (data as any).cr_number || (data as any).crNumber,
        vatNumber: (data as any).vat_number || (data as any).vatNumber
      };
      delete (data as any).company_name;
      delete (data as any).companyName;
      delete (data as any).cr_number;
      delete (data as any).crNumber;
      delete (data as any).vat_number;
      delete (data as any).vatNumber;
